...
var FifteenthTitle = /** @class */ (function () {
    ...
    _a = FifteenthTitle, _FifteenthTitle_get = function _FifteenthTitle_get() {
        ...
        var itemWithTitle = resData.find(function (item) { return item.id === __classPrivateFieldGet(FifteenthTitle, _a, "f", _FifteenthTitle_ID); }); // Добавлен вызов метода find()
        var title = itemWithTitle === null || itemWithTitle === void 0 ? void 0 : itemWithTitle.title; // Добавлен оператор безопасного доступа '?'
